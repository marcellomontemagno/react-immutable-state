(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("react-immutable-state", [], factory);
	else if(typeof exports === 'object')
		exports["react-immutable-state"] = factory();
	else
		root["react-immutable-state"] = factory();
})(this, function() {
...
var _immutableState = __webpack_require__(2);

Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_immutableState).default;
  }
});
    ...
    if (process.env.NODE_ENV !== "production") {
        ...
        result = function (_Component) {
            ...
            function result(props) {
                ...
                if (_this.state) {
                    _this.state = (0, _deepFreeze2.default)(_this.state);
                }
                return _this;
            }
        ...
        var originalSetState = Component.prototype.setState;
        ...
        Component.prototype.setState = function (state, callback) {
            originalSetState.call(this, (0, _deepFreeze2.default)(state), callback);
        };
    }
